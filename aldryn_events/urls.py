...
urlpatterns = patterns('aldryn_events.views',  # NOQA
   ...
   url(r'^list-ajax/(?P<year>\d{4})/$', 'event_list_ajax', name='events_list_ajax-by-year'),
    url(r'^list-ajax/(?P<year>\d{4})/(?P<month>\d{1,2})/$', 'event_list_ajax',
        name='events_list_ajax-by-month'),
    url(r'^list-ajax/(?P<year>\d{4})/(?P<month>\d{1,2})/(?P<day>\d{1,2})/$',
        'event_list_ajax', name='events_list_ajax-by-day'),
)
